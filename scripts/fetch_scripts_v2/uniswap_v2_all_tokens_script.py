...
def get_all_tokens_v2() -> pd.DataFrame:
    """
...
def uniswap_v2_all_tokens() -> None:
    """
    Fetch all the tokens (snapshot) in V2 and save to file named with executing date
    """

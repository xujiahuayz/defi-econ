# -*- coding: utf-8 -*-
"""# Fetch all tokens for Uniswap V3"""
...
def get_all_tokens_v3():
  ...
  """
    get_all_tokens_batch0 = subgraph.run_query(
        subgraph.http_v3, get_all_tokens_batch0_query
    )
    ...
    """
        tokens_result_iter = subgraph.run_query_var(
            subgraph.http_v3, query_iter, params_id_gt
        )
...
if __name__ == "__main__":
    ...
    file_name = (
        "data_uniswap_v3/fetched_data_v3/uniswap_v3_all_tokens_" + file_date + ".csv"
    )

    # Write dataframe to csv
    df_all_tokens = get_all_tokens_v3()
